...
from app.domains.finance.routers.receipt import router as receipt_router
from app.domains.finance.routers.savings_goals import router as savings_goals_router
