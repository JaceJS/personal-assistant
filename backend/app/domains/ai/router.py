...
_SYSTEM_PROMPT = (
    ...
    "If get_accounts returns an empty list, tell the user they need to create an account "
    "first before you can do anything with transactions or categories — do not claim any "
    ...
    "it wasn't. More generally: never claim any account, category, budget, or transaction "
