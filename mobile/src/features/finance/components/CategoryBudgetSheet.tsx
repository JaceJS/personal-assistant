...
function CategoryBudgetSheet({ category, isVisible, onDismiss }: CategoryBudgetSheetProps) {
  ...
  const inputLabel = isFixed
    ? t("budget.category.monthlyAmountFixedLabel")
    : t("budget.category.monthlyLimitLabel");
        ...
        <Button
          label={
            updateCategory.isPending
              ? t("budget.savingEllipsis")
              : t("budget.category.saveLimitCta")
          }
          onPress={handleSave}
          variant="primary"
